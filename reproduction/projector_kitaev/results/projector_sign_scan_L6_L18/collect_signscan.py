...
l6, l12, l18 = collect(6), collect(12), collect(18)
plot(l6, BASE/'collected'/'L6_average_sign.png', 'L=6, static projector')
plot(l12, BASE/'collected'/'L12_average_sign.png', 'L=12, static projector')
plot(l18, BASE/'collected'/'L18_average_sign.png', 'L=18, static projector')
plt.figure(figsize=(5.2,3.6))
for data, label in ((l6,'L=6'),(l12,'L=12'),(l18,'L=18')): plt.errorbar([float(r['V']) for r in data],[float(r['average_sign']) for r in data],yerr=[float(r['average_sign_error']) for r in data],marker='o',capsize=3,label=label)
