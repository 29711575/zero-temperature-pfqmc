...
base=Path(__file__).resolve().parent; task=int(sys.argv[1]); result_root=Path(os.environ.get('MPZ2_RESULT_ROOT',str(base/'results'))); out=result_root/'controls'/f'task_{task:02d}';out.mkdir(parents=True,exist_ok=False)
